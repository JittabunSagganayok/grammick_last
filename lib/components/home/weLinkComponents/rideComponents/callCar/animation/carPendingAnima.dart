...
class carPendingAnima extends StatefulWidget {
  carPendingAnima({Key? key, this.buttonTop}) : super(key: key);
  final int? buttonTop;

  @override
  State<carPendingAnima> createState() => _carPendingAnimaState();
}

class _carPendingAnimaState extends State<carPendingAnima> {
  var timerEnd = 'start';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      await  Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => arrivalPickUp(buttonTop: widget.buttonTop)),
        );
      },
      child: Stack(
        children: [
