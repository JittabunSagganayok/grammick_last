...
import 'package:we_link/components/home/weLinkComponents/weRentComponents/weRentCallCar/weRentArrival.dart';

class weRentPending extends StatefulWidget {
  weRentPending({Key? key}) : super(key: key);

  @override
  State<weRentPending> createState() => _weRentPendingState();
}

class _weRentPendingState extends State<weRentPending> {
    ...
    return Scaffold(
      ...
      onTap: () async {
        ...
        await Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => weRentArrival(WeRentArrival: 'WeRentArrival')),
        );
      },
      child: Stack(
        children: [
          ...
          Positioned(top: 70, right: 0, left: 0, child: weRentTop()),
          Positioned(bottom: 0, right: 0, left: 0, child: weRentBottom())
        ],
      ),
    ));
  }
