...
void yourCarInformation(
    BuildContext context, DriveYourArrival, DriveYourRideBegan) {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 10),
                          if (DriveYourArrival != 'DriveYourArrival' &&
                              DriveYourRideBegan != 'DriveYourRideBegan') ...[
                            Divider(
                              color: Color(0xFFE6E6E6),
                              thickness: 1,
                            ),
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          WeLinkToGoScreen(valueSelectedIndex: 1)),
                                );
                              },
                              child: Row(
