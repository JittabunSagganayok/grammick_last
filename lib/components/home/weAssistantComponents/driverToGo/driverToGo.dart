...
import 'package:we_link/components/home/weAssistantComponents/driverToGo/driverToGoAnimation.dart';
...
class driverToGo extends StatefulWidget {
  driverToGo({Key? key, this.OrderDetail}) : super(key: key);
  final String? OrderDetail;

  @override
  State<driverToGo> createState() => _driverToGoState();
}

class _driverToGoState extends State<driverToGo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => driverToGoAnimation()),
        );
      },
      child: Stack(
        children: [
